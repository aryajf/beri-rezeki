                ...
                <div class="admin-panel-responsive">
                    <div class="admin-panel">
                        ...
                        <router-link to="/program/single" class="btn btn-sm"><i class="uil uil-file-bookmark-alt me-1"></i>
                            Single Program <span class="badge bg-wa ms-1">{{programs.totalItems}}</span>
                        </router-link>
                        <router-link to="/program/crowdfunding" class="btn btn-sm"><i class="uil uil-file-bookmark-alt me-1"></i>
                            Crowdfunding Program <span class="badge bg-wa ms-1">{{crowdTotal}}</span>
                        </router-link>
                    </div>
                </div>
...
export default {
    ...
    methods: {
        ...
        getPrograms() {
            this.$store.dispatch('program/getPrograms', { page: 0, keyword: this.keyword, type: 'single' })
        },
        setTotalProgram() {
            this.$store.dispatch('program/setTotalProgram')
        },
        changePage(event) {
            this.$store.dispatch('program/getPrograms', {page: event.page, keyword: this.keyword, type: 'single' })
        },
    },
}
</script>
