                ...
                <div class="admin-panel-responsive">
                    <div class="admin-panel">
                        <router-link to="/program" class="btn btn-sm"><i class="uil uil-file-bookmark-alt me-1"></i>
                            Semua Program <span class="badge bg-wa ms-1">{{programs.totalItems}}</span>
                        </router-link>
...
export default {
    ...
    methods: {
        ...
        getPrograms() {
            this.$store.dispatch('program/getPrograms', { page: 0, keyword: this.keyword })
        },
        changePage(event) {
            this.$store.dispatch('program/getPrograms', { page: event.page, keyword: this.keyword })
        }
    },
}
</script>
